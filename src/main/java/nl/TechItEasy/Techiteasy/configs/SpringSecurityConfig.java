package nl.TechItEasy.Techiteasy.configs;

import nl.TechItEasy.Techiteasy.filters.JwtRequestFilter;
...
//                .antMatchers("/**").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/televisions").hasAnyRole("ADMIN", "USERS")
